...
[here](https://godoc.org/go.sadegh.io/telebot#pkg-constants).
...
implementations:
```go
import "go.sadegh.io/telebot/middleware"
```
...
[here](https://pkg.go.dev/go.sadegh.io/telebot#Option).
...
1. Fork it
2. Clone v3: `git clone -b v3 https://github.com/xsadegh/telebot`
