...
type ReplyButton struct {
	...
	Location bool            `json:"request_location,omitempty" yaml:"request_location,omitempty"`
	Poll     PollType        `json:"request_poll,omitempty" yaml:"request_poll,omitempty"`
	User     *ReplyRecipient `json:"request_users,omitempty" yaml:"request_users,omitempty"`
	Chat     *ReplyRecipient `json:"request_chat,omitempty" yaml:"request_chat,omitempty"`
	WebApp   *WebApp         `json:"web_app,omitempty" yaml:"web_app,omitempty"`
}
...
type InlineButton struct {
	...
	EmojiID               string             `json:"icon_custom_emoji_id,omitempty" yaml:"icon_custom_emoji_id,omitempty"`
	InlineQuery           string             `json:"switch_inline_query,omitempty" yaml:"switch_inline_query,omitempty"`
	InlineQueryChat       string             `json:"switch_inline_query_current_chat" yaml:"switch_inline_query_current_chat,omitempty"`
	InlineQueryChosenChat *SwitchInlineQuery `json:"switch_inline_query_chosen_chat,omitempty" yaml:"switch_inline_query_chosen_chat,omitempty"`
	Login                 *Login             `json:"login_url,omitempty" yaml:"login_url,omitempty"`
	WebApp                *WebApp            `json:"web_app,omitempty" yaml:"web_app,omitempty"`
	CallbackGame          *CallbackGame      `json:"callback_game,omitempty" yaml:"callback_game,omitempty"`
	Pay                   bool               `json:"pay,omitempty" yaml:"pay,omitempty"`
	CopyText              *CopyTextButton    `json:"copy_text,omitempty" yaml:"copy_text,omitempty"`
}
...
type Login struct {
	...
	Text        string `json:"forward_text,omitempty" yaml:"forward_text,omitempty"`
	Username    string `json:"bot_username,omitempty" yaml:"bot_username,omitempty"`
	WriteAccess bool   `json:"request_write_access,omitempty" yaml:"request_write_access,omitempty"`
}
